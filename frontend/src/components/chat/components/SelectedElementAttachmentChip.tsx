...
export function SelectedElementAttachmentChip({
  ...
  return (
    <div className="flex max-w-full items-center gap-2 rounded-2xl border border-neutral-200 bg-white px-2 py-2 text-left shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
      {attachment.previewUrl ? (
        <button
          ...
          onClick={() => onPreviewClick?.(attachment.previewUrl)}
        >
          <img
