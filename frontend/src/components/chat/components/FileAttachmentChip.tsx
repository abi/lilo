...
export function FileAttachmentChip({
  ...
  const isImage = attachment.kind === "image" || attachment.type.startsWith("image/");
  const canOpen = Boolean(onOpen);

  return (
    <div
      className={`flex max-w-full items-center gap-2 rounded-2xl border border-neutral-200 bg-white px-2.5 py-2 text-left shadow-sm dark:border-neutral-700 dark:bg-neutral-900 ${
        canOpen
    ...
    >
      <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-neutral-200 bg-neutral-50 text-neutral-400 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-500">
